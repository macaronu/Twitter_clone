...
class InvalidSignupTests(TestCase):
    ...
    def test_numeric_invalid_password(self):
        ...
        self.assertFormError(
            response, "form", "password2", "This password is entirely numeric."
        )
        self.assertEquals(response.status_code, 200)
...
class GetViewTests(TestCase):
    ...
    def test_unauthenticated_get_my_edit_profile_view(self):
        ...
        self.assertRedirects(
            response, reverse("user:home"), status_code=302, target_status_code=302
        )
        self.assertNotIn(SESSION_KEY, self.client.session)
...
class EditProfileTests(TestCase):
    ...
    def test_valid_img_edit(self):
        ...
        self.assertEqual(
            self.user.profile.profile_img.name,
